...
.side-bar .menu .item .p a ul .fas{
  ...
  <body>
      ...
      <div class="menu">
      <div class="item">
  <div class="heading"><p style="font-family:Castellar">ADD EXPENSE</p></div>
    ...
    <form>-->
                <form action="expense_page.php" method="post" class="form">
                ...
                <div class="content">
                 ...
                 <div class="transaction"><a href="extransaction.php">View expense details</a></div>
                </form>
                <!--</form></form>-->
    </div>
    </div>
...
if(isset($_POST['date'],$_POST['amount'],$_POST['category'],$_POST['userid']))
{
  $date = $_POST['date'];
  $amount = $_POST['amount'];
